  ...
  return (
    ...
    <section className="container-fluid" id="portfolioSection">
      <div className="row justify-content-center">
        ...
        <img alt="icon brackets" className="codingIcon" src={dev} />
      </div>
        ...
        <ul className="nav justify-content-md-end justify-content-center">
          ...
          <li>
            ...
            <a
              ...
              style={{
                color:
                  currentItemState === "React Apps" ? "dodgerblue" : "black",
              }}
              onClick={handleClick}
            >
              React Apps
          ...
          <li>
            ...
            <a
              ...
              style={{
                color:
                  currentItemState === "Full Stack" ? "dodgerblue" : "black",
              }}
              onClick={handleClick}
            >
              Full Stack
          ...
          <li>
            ...
            <a
              ...
              style={{
                color:
                  currentItemState === "Browser Apps" ? "dodgerblue" : "black",
              }}
              onClick={handleClick}
            >
              Browser Apps
          ...
          <li>
            ...
            <a
              ...
              name="CLI Apps"
              style={{
                color: currentItemState === "CLI Apps" ? "dodgerblue" : "black",
              }}
              onClick={handleClick}
            >
              CLI Apps
